...
print("compute_total SAVE10:", timeit.timeit("compute_total(items, 'SAVE10')", setup=SETUP, number=20000))
print("compute_total WELCOME20:", timeit.timeit("compute_total(items, 'WELCOME20')", setup=SETUP, number=20000))
